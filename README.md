...
# Learn basic python
You want to learn python but don't know where to start. You want to know what python is but don't have much time. Don't worry,  _[here](https://pythonid.com/tutorials/python-getting-started)_ we help you improve your python knowledge and do the exercises _[here](https://pythonid.com/user/ductai/projects/python-basic)_, you will improve every day.
